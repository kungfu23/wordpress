...
== Description ==
A very simple plugin to add gallery meta box in your post, page and and create a Image gallery menu tab in WordPress menu section and display Gallery on frontend of your website in a slider OR carousel view with the help of shorcode. The gallery field provides a simple and intuitive interface for managing a collection of images.

View [DEMO](http://wponlinesupport.com/wp-plugin/meta-slider-carousel-lightbox/) | [PRO DEMO](http://wponlinesupport.com/wp-plugin/meta-slider-carousel-lightbox/)  for additional information.
...
Checkout our [Album and Image Gallery Plus Lightbox](http://wponlinesupport.com/wp-plugin/album-image-gallery-plus-lightbox/) Grid OR Slider with 15 various designs.
