	...
	<tbody>
		<tr valign="top">
			...
			<td>
				...
				<span class="description"><?php _e('Choose your desired images for gallery. Hold Ctrl key to select multiple images at a time.', 'meta-slider-and-carousel-with-lightbox'); ?></span>
			</td>
		</tr>
	</tbody>
