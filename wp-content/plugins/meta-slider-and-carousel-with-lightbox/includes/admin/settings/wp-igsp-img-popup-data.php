...
<div class="wp-igsp-popup-body">
	...
	<form method="post" class="wp-igsp-attachment-form">
		...
		<table class="form-table">
			...
			<tr>
				<th><label for="wp-igsp-attachment-desc"><?php _e('Description', 'meta-slider-and-carousel-with-lightbox'); ?>:</label></th>
				<td>
					<textarea name="wp_igsp_attachment_desc" class="large-text wp-igsp-attachment-desc" id="wp-igsp-attachment-desc"><?php echo wp_igsp_esc_attr($attachment_post->post_content); ?></textarea>
					<span class="description"><?php _e('Enter image description.', 'meta-slider-and-carousel-with-lightbox'); ?></span>
				</td>
			</tr>

			<tr>
				<th><label for="wp-igsp-attachment-link"><?php _e('Image Link', 'meta-slider-and-carousel-with-lightbox'); ?>:</label></th>
				<td>
					...
					<span class="description"><?php _e('Enter image link. e.g http://wponlinesupport.com', 'meta-slider-and-carousel-with-lightbox'); ?></span>
				</td>
			</tr>
